...
- 小数乘法、整数乘法
- 矩形面积、平行四边形面积、三角形面积、梯形面积、组合图形面积
- 整数除法、分数基础、分数的意义、分数的基本性质
...
1. 按知识图谱的高连接度补齐深度课件：位置值、小数除法、简易方程、体积和体积单位。
2. 补齐五下核心链路：因数与倍数、质数与合数、长方体和正方体、长方体体积。
3. 把高频交互抽象为组件，例如数轴、面积模型、分数条、天平、三维长方体。
4. 继续扩展 visual metaphor 图像资产，让每个高频误区概念都有可视化入口。
