...
const imageByConcept = {
  ...
  '用数对确定位置':'assets/concepts/place-value-tower.webp',
  '小数近似数':'assets/concepts/decimal-multiply.webp',
  '不规则图形面积估算':'assets/concepts/polygon-area.webp',
  '奇数和偶数':'assets/concepts/number-theory-sieve.webp',
  '公因数和最大公因数':'assets/concepts/number-theory-sieve.webp',
  '公倍数和最小公倍数':'assets/concepts/number-theory-sieve.webp',
  '长方体正方体表面积':'assets/concepts/volume-cubes.webp',
  '分数与除法的关系':'assets/concepts/fraction-meaning.webp',
  '分数加减混合运算':'assets/concepts/fraction-meaning.webp',
  '旋转三要素':'assets/concepts/polygon-area.webp',
  '复式折线统计图':'assets/concepts/statistics-trend.webp'
};

const visualByConcept = {
  '整数加减法':['➕','数块在天平上进出，数量随操作变多或变少','同单位计数'],
  '用数对确定位置':['📍','方格纸上的坐标定位，列和行确定唯一位置','坐标定位'],
  '小数近似数':['🎯','用四舍五入法把小数约到指定位数，取最接近的值','四舍五入'],
  '不规则图形面积估算':['📐','数方格：满格计1，半格以上计1，不满半格不计','数格估算'],
  '奇数和偶数':['🔢','2的倍数=偶数，不是2的倍数=奇数；决定性质的只是个位','奇偶分类'],
  '公因数和最大公因数':['🔗','两个数公有的因数中最大的那个，约分的核心工具','最大公因数'],
  '公倍数和最小公倍数':['🔗','两个数公有的倍数中最小的那个，通分的核心工具','最小公倍数'],
  '长方体正方体表面积':['📦','6个面的总面积，展开图就是全部面的和','展开求和'],
  '分数与除法的关系':['➗','分子÷分母=分数线，a÷b=a/b(b≠0)','分数即除法'],
  '分数加减混合运算':['➕','顺序同整数，运算律对分数也适用，可约简先约简','混合计算'],
  '旋转三要素':['🔄','中心点不动，顺时针或逆时针转指定角度','中心·方向·角度'],
  '复式折线统计图':['📊','多条折线在同一图中对比，看不同组的变化差异','多线对比'],
...
const lessonByConcept = {
  ...
  '用数对确定位置':{href:withHash('modules/04-place-value/4-1-place-value.html','用数对确定位置'),label:'进入位置课件',meta:'坐标思想'},
  '小数近似数':{href:withHash('modules/02-dec-division/2-1-dec-division.html','小数近似数'),label:'进入小数除法课件',meta:'近似取整'},
  '不规则图形面积估算':{href:withHash('modules/06-polygon-area/index.html','不规则图形面积估算'),label:'进入多边形面积模块',meta:'数格估算'},
  '奇数和偶数':{href:withHash('modules/09-factors/9-5-divisibility.html','奇数和偶数'),label:'进入倍数特征课件',meta:'奇偶分类'},
  '公因数和最大公因数':{href:withHash('modules/09-factors/9-3-reduction.html','公因数和最大公因数'),label:'进入约分课件',meta:'公因数'},
  '公倍数和最小公倍数':{href:withHash('modules/09-factors/9-4-common-denominator.html','公倍数和最小公倍数'),label:'进入通分课件',meta:'公倍数'},
  '长方体正方体表面积':{href:withHash('modules/07-volume/7-2-cuboid.html','长方体正方体表面积'),label:'进入长方体课件',meta:'展开图'},
  '分数与除法的关系':{href:withHash('modules/14-fraction-meaning/14-2-division.html','分数与除法的关系'),label:'进入分数与除法课件',meta:'分数线'},
  '分数加减混合运算':{href:withHash('modules/10-fraction-ops/10-1-fraction-add-sub.html','分数加减混合运算'),label:'进入分数加减课件',meta:'混合运算'},
  '旋转三要素':{href:withHash('modules/08-geometry-intro/8-3-symmetry.html','旋转三要素'),label:'进入对称旋转课件',meta:'中心·方向·角度'},
  '复式折线统计图':{href:withHash('modules/11-statistics/11-2-line-chart.html','复式折线统计图'),label:'进入折线图课件',meta:'多线对比'},
