...
const lessonByConcept = {
  ...
  '用数对确定位置':{href:withHash('modules/04-place-value/4-4-coordinates.html','用数对确定位置'),label:'进入数对课件',meta:'坐标思想'},
  '小数近似数':{href:withHash('modules/02-dec-division/2-3-approximation.html','小数近似数'),label:'进入近似课件',meta:'近似取整'},
  '不规则图形面积估算':{href:withHash('modules/06-polygon-area/6-4-irregular.html','不规则图形面积估算'),label:'进入不规则面积课件',meta:'数格估算'},
  '奇数和偶数':{href:withHash('modules/09-factors/9-6-odd-even.html','奇数和偶数'),label:'进入奇偶课件',meta:'奇偶分类'},
  '公因数和最大公因数':{href:withHash('modules/09-factors/9-7-gcf.html','公因数和最大公因数'),label:'进入公因数课件',meta:'公因数'},
