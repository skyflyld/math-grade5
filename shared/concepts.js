...
const svgByConcept = {
  '整数加减法':'assets/concepts/int-add-sub.svg',
  '整数乘法':'assets/concepts/int-multiply.svg',
  '整数除法':'assets/concepts/int-division.svg',
  '位置值':'assets/concepts/place-value.svg',
  '小数的意义':'assets/concepts/dec-meaning.svg',
  '整数四则运算':'assets/concepts/four-ops.svg',
  '矩形面积':'assets/concepts/rect-area.svg',
  '等式的性质':'assets/concepts/equality.svg',
  '图形认知':'assets/concepts/shape-cog.svg',
  '分数基础':'assets/concepts/fraction-basics.svg',
  '数据收集':'assets/concepts/data-collect.svg',
  '单位换算':'assets/concepts/unit-convert.svg',
  '小数乘法':'assets/concepts/dec-multiply.svg',
  '小数除法':'assets/concepts/dec-division.svg',
  '因数和倍数':'assets/concepts/factors-multiples.svg',
  '235的倍数特征':'assets/concepts/divisibility-235.svg',
  '循环小数':'assets/concepts/recurring-dec.svg',
  '观察物体':'assets/concepts/observe-objects.svg',
  '质数与合数':'assets/concepts/prime-composite.svg',
  '简易方程':'assets/concepts/simple-equation.svg',
  '长方体和正方体':'assets/concepts/cuboid.svg',
  '平行四边形面积':'assets/concepts/para-area.svg',
  '体积和体积单位':'assets/concepts/volume-unit.svg',
  '三角形面积':'assets/concepts/tri-area.svg',
  '长方体体积':'assets/concepts/cuboid-volume.svg',
  '梯形面积':'assets/concepts/trap-area.svg',
  '组合图形面积':'assets/concepts/comb-area.svg',
  '容积和容积单位':'assets/concepts/capacity.svg',
  '分数的意义':'assets/concepts/fraction-meaning.svg',
  '真分数和假分数':'assets/concepts/proper-improper.svg',
  '可能性':'assets/concepts/probability.svg',
  '植树问题':'assets/concepts/tree-planting.svg',
  '分数的基本性质':'assets/concepts/frac-property.svg',
  '约分':'assets/concepts/reduction.svg',
  '通分':'assets/concepts/common-denom.svg',
  '分数加减法':'assets/concepts/frac-add-sub.svg',
  '分数与小数互化':'assets/concepts/frac-dec-convert.svg',
  '折线统计图':'assets/concepts/line-chart.svg',
  '找次品':'assets/concepts/find-faulty.svg',
  '轴对称与旋转':'assets/concepts/axis-symmetry.svg',
  '用数对确定位置':'assets/concepts/coordinates.svg',
  '小数近似数':'assets/concepts/dec-approx.svg',
  '不规则图形面积估算':'assets/concepts/irregular-area.svg',
  '奇数和偶数':'assets/concepts/odd-even.svg',
  '公因数和最大公因数':'assets/concepts/gcf.svg',
  '公倍数和最小公倍数':'assets/concepts/lcm.svg',
  '长方体正方体表面积':'assets/concepts/surface-area.svg',
  '分数与除法的关系':'assets/concepts/frac-division.svg',
  '分数加减混合运算':'assets/concepts/frac-mixed-ops.svg',
  '旋转三要素':'assets/concepts/rotation.svg',
  '复式折线统计图':'assets/concepts/dual-line.svg'
};
